...
* c: a small number, e.g. 0 < c < 0.005. Greater c causes the model to be more sparse, especially at the early stage of training. This usually has small effect on the late stage of training. The influence of c is smaller than th influence of mu.
