...
"Generalized Regularized Dual Averaging" is an optimizer that can learn a small sub-network, if one starts from an overparameterized dense network. Paper preprint is coming soon.
