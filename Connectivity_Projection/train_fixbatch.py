...
parser.add_argument('--grda', type=str, default=False, metavar='GRDA',
                    help='use gRDA as optimizer (default: False)')
parser.add_argument('--c', type=float, default=0.001, metavar='C',
                    help='gRDA c (default: 0.001)')
...
if args.grda:
    optimizer = gRDA(filter(lambda param: param.requires_grad, model.parameters()), lr=args.lr, c=args.c, mu=args.mu)
